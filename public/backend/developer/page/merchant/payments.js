$(document).ready(function() {
    ...
    var dataTable = $('#orders-table').DataTable( {
        ...
        "lengthChange": true,
        "ajax":{
            url : BASE_URL+'/merchant/report/payment/get-payments-data', // json datasource
    ...
    $('#search_date').on('apply.daterangepicker', function(ev, picker) {
        ...
        dataTable.columns(11).search( picker.startDate.format('YYYY-MM-DD')+'/'+picker.endDate.format('YYYY-MM-DD') ).draw();
    });
