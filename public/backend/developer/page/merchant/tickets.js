$(document).ready(function() {
    ...
    var dataTable = $('#orders-table').DataTable( {
        ...
        "lengthChange": true,
        "ajax":{
            url : BASE_URL+'/merchant/report/ticket/get-tickets-data', // json datasource
...
function viewTicketDetails(event_booking_ticket_detail_id)
{
    $('#ajaxLoader').show();
    $.ajax({
        headers: {
        ...
        url: BASE_URL+'/merchant/report/ticket/view-ticket-detail/'+event_booking_ticket_detail_id,
        type: 'GET',
        success: function (data) {
            $('#view-ticket-detail-modal-body').html(data);
            $('#view-ticket-detail-modal').modal('show');
            $('#ajaxLoader').hide();
        },
        error: function () {
            $('#ajaxLoader').hide();
