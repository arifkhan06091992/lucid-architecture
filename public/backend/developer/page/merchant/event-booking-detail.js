...
function view_event_ticket(event_booking_id)
{
    ...
    $.ajax({
        ...
        url: BASE_URL+'/merchant/booking/view-event-ticket/'+event_booking_id,
        type: 'GET',
...
function cancelEventBooking(event_booking_id)
{
    ...
    $.ajax({
        ...
        url: BASE_URL+'/merchant/booking/cancel-event-booking/'+event_booking_id,
        type: 'GET',
        success: function (data) {
...
function contactOrganizer(event_booking_id)
{
    ...
    $.ajax({
        ...
        url: BASE_URL+'/merchant/booking/contact-organizer/'+event_booking_id,
        type: 'GET',
        success: function (data) {
