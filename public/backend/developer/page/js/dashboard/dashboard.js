$(document).ready(function () {
    ...
    $('input[type=radio][name=dashboard_count_boxes_type]').on('ifChecked',function() {
        ...
        $('#ajaxLoader').show();
        $.ajax({
            url: BASE_URL+'/admin/dashboard/dashboard-count-boxes',
            type: 'POST',
    ...
    $('#total_sales_chart_event_id').change(function(){
        ...
        $('#ajaxLoader').show();
        $.ajax({
            url: BASE_URL+'/admin/dashboard/dashboard-total-sale-chart',
            type: 'POST',
    ...
    $('#total_revenue_chart_event_id').change(function(){
        ...
        $('#ajaxLoader').show();
        $.ajax({
            url: BASE_URL+'/admin/dashboard/dashboard-total-revenue-chart',
            type: 'POST',
            data: { "event_id": this.value , _token : _token},
            success: function (data) {
    ...
    $('#sales_by_gender_event_id').change(function(){
        ...
        $('#ajaxLoader').show();
        $.ajax({
            url: BASE_URL+'/admin/dashboard/dashboard-sales-by-gender-chart',
            type: 'POST',
            data: { "event_id": this.value , _token : _token},
            success: function (data) {
    ...
    $('#sales_by_age_range_event_id').change(function(){
        ...
        $('#ajaxLoader').show();
        $.ajax({
            url: BASE_URL+'/admin/dashboard/dashboard-sales-by-age-range-chart',
            type: 'POST',
            data: { "event_id": this.value , _token : _token},
            success: function (data) {
